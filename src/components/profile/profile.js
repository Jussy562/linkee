  ...
  return (
    ...
    <div class=" flex items-center mb-6 ">
        <div className='flex flex-row w-full bg-none justify-center items-center'>
            <div className='flex items-end w-half bg-white'>
                <div className='flex flex-col justify-between items-center'>
                    <img src='/images/profile-pic.png' className=' mb-6 md:h-20 md:w-22 h-20 w-20 rounded-full' alt='Profile' />
                    <h3 className='text-3xl text-black-900 bold'>Justice Paago</h3>
                </div>
            </div>
            <div className='hidden md:block w-half bg-grey-500' id='navbar-default'>
